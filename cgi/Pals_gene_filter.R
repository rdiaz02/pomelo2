...
results.file <- read.table("multest_parallel.res", header = TRUE, skip = 13, sep="\t", quote="", stringsAsFactors = TRUE)
PalsOpts  <- read.table("Pals_Opts", header = TRUE, sep = "\t", stringsAsFactors = TRUE)
