...
def printOKRun():
    ...
    dummy = os.system("cd " + tmpDir + "; python /http/pomelo2/www/cgi-bin/heatmap_draw_script.py << heat_table.log; python2.4 /http/pomelo2/www/cgi-bin/generate_table.py; << heat_table.log")
    Heatresults = open(tmpDir + "/heat_new.html")
    table_file  = open(tmpDir + "/p.v.sort.name.d.html")
